...
class TeldACASTRO:
    ...
    def criar_widgets(self):
        ...
        self.subtitle_label = Label(self.main_frame, text="Painel do ATENDENTE", font=self.label_font,
                                    bg="#002333", fg="#a0a0a0")
    ...
    def CRUD_cliente(self):
        self.root.destroy()
        from cadastro_clienteatendente import Abrir_Cliente
        root = Tk()
        root.geometry("800x400")
        Abrir_Cliente(root)
        root.mainloop()
    ...
    def pedido(self):
        self.root.destroy()
        from pedidoatendente import AbrirPedido_adm
        root = Tk()
        root.geometry("800x400")
        AbrirPedido_adm(root)
        root.mainloop()
