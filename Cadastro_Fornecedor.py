...
QuantidadeFornecedorLabel = ttk.Entry(width=30) #Cria um campo para colocar a quantidade de produto fornecido
QuantidadeFornecedorLabel.place(x=150,y=280)
...
def RegistrarNoBancoFornecedor(): #Registra os dados no banco de dados
    ...
    quantidade=QuantidadeFornecedorLabel.get()


    if fornecedor == "" or cpf == "" or telefone == "" or email == "" or endereco == "" or produto == "" or quantidade == "": #Verifica se os campos de textos estão vazios
...
def LimparCampos():
    ...
    QuantidadeFornecedorLabel.delete(0,END) #Limpa o campo de entrada da quantidade de produto
